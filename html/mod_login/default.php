...
<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" id="login-form" class="form-inline">
	...
	<div class="userdata">
		...
		<div id="form-login-submit" class="control-group">
			<div class="controls">
				<button type="submit" tabindex="0" name="Submit" class="waves-effect waves-light btn btn-primary"><?php echo JText::_('JLOGIN') ?></button>
			</div>
		</div>
		<?php
			...
			<?php if ($usersConfig->get('allowUserRegistration')) : ?>
				<li>
					...
					<?php echo JText::_('MOD_LOGIN_REGISTER'); ?> <span class="mdi-navigation-arrow-forward"></span></a>
				</li>
			<?php endif; ?>
				<li>
